...
<div class="row">
  <div class="col-md-12">
    ...
    <a href="{{ route('author.post.create') }}" title="Tambah Postingan" rel="tooltip" class="btn btn-info btn-round">
        <i class="material-icons">add</i>
    </a>

    {{-- search post --}}
    <form method="GET" action="{{ route('author.searchPostAuthor') }}" class="pull-right">
      @csrf
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-danger">
          ...
          <span class="label badge-pill badge-primary pull-right">{{ $posts->count() }} Postingan</span>
