...
<div class="row">
    <div class="col-md-12">
        ...
        <a href="{{ route('author.gallery.edit', $gallery->id) }}" class="btn btn-success">
        ...
        <div class="card">
            <div class="card-header card-header-rose">
                ...
                <p class="card-category">Yang bikin <strong>{{ $gallery->user->name }}</strong>
                    <span class="pull-right"><i class="material-icons">access_time</i> {{ $gallery->created_at->toFormattedDateString() }}</span>
                </p>
            </div>
            <div class="card-body">
                <div class="row">
