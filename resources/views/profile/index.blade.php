...
<div class="main">
  ...
  <div class="section section-dark-blue">
      ...
      <!-- Gambar Header Postingan -->
      <div class="page-header page-header-xs bg-primary mb-5">
        <h2 class="text-white">{{ $author->name }} Posts</h2> &nbsp;
        <h6 class="mt-5"> {{ $counted }} Postingan</h6>
      </div>
      <!-- End Gambar Header Postingan -->
    ...
    <div class="container-fluid">
      <div class="row">
          ...
          @foreach ($posts as $post)
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                  ...
                  <a href="{{ route('post.detail',$post->slug) }}" class="btn btn-outline-primary btn-lg mt-5">See Details</a>
              </div>
            </div>

            <div class="progress mt-2">
                <div class="progress-bar progress-bar-primary" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div><br/>
        ...
        <!-- End Kolom kiri Postingan -->

        <!-- Kolom kanan Postingan -->
        <div class="col-lg-3 col-md-4 col-sm-6">

        <!-- Aubot Author -->
        <div class="card bg-primary text-white">
            <div class="card-body text-white">
                <h4 class="card-title text-white text-center">About Author</h4>
                
                <!-- Poto Author Postingan -->
                <div id="images" class="text-center">
                    <a href="{{ route('author.profile', $post->user->username) }}">
                        <img src="{{ Storage::disk('public')->url('profile/'.$author->image) }}" class="img-circle img-no-padding img-responsive" alt="{{ $author->name }}">
                    </a>
                    
                    <!-- Nama Author Postingan -->
                    <p>
                      <strong class="text-center">{{ $author->name }}</strong>
                    </p>

                </div>

                <!-- Tentang Author Postingan -->
                <p class="text-center">{{ $author->about }}</p>

                <br>
                <!-- Banyak Postingan -->
                <strong>Total Postingan : {{ $counted }}</strong>
