...
<body class="permission_denied">
    ...
    <div class="denied__wrapper">
          <h1>404</h1>
          <h3>LOST IN <span>SPACE</span> Yowis Ben Pages? Hmm, looks like that page doesn't exist.</h3>
        ...
        <svg id="planet" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          ...
          <a href="{{ route('home') }}"><button class="denied__link">Go Home to The Earth</button></a>
        </div>
</body>
