...
<div class="main">
  ...
  <div class="section section-dark-blue">
      ...
      <div class="page-header page-header-xs bg-brown mb-5">
        <h2 class="text-white">{{ $posts->total() }} Results for {{ $query }}</h2>
      </div>
    ...
    <div class="container-fluid">
      <div class="row">
            ...
            @foreach ($posts as $post)
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <a href="{{ route('post.detail',$post->slug) }}" class="btn btn-outline-brown btn-lg mt-5">See Details</a>
                </div>

              </div>

            <div class="progress mt-2">
                <div class="progress-bar progress-bar-brown" role="progressbar" style="width: 100%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
            </div><br/>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <!-- Search -->
          <div class="card bg-brown text-white text-center">
          ...
          <!-- About -->
          <div class="card bg-brown text-center">
            <div class="card-body text-white">
