...
<div class="main">
  ...
  <div class="section section-dark-blue">
    ...
    <!-- Header -->
    <div class="page-header page-header-xs mb-5" style="background-image: url({{ Storage::disk('public')->url('category/'.$category->image) }});">
            ...
            @foreach ($posts as $post)
              <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <a href="{{ route('post.detail',$post->slug) }}" class="btn btn-outline-success btn-lg mt-5">See Details</a>
                </div>
                <!-- End Column body -->
