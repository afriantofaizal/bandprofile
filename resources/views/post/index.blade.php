...
<div class="main">
  ...
  <div class="section section-dark-blue">
      ...
      <div class="page-header bg-danger page-header-xs mb-5">
        <h2 class="text-white">{{ $posts->total() }} POSTINGAN</h2>
      </div>
      ...
      <div class="row">
          ...
          @foreach ($posts as $post)
            <div class="row">
              ...
              <div class="col-md-6 col-sm-12">
                  ...
                  <a href="{{ route('post.detail',$post->slug) }}" class="btn btn-outline-danger btn-lg mt-5">See Details</a>
              </div>
            </div>
        ...
        <div class="col-lg-3 col-md-4 col-sm-6">
          ...
          <div class="card bg-danger text-center">
              <div class="card-body">
                  <h4 class="card-title text-white">All Tags</h4>
                  @foreach ($tags as $tag)
