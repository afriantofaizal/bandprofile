...
<div class="row">
  <div class="col-md-12">
    ...
    <a href="{{ route('admin.gallery.create') }}" title="Tambah Gallery" rel="tooltip" class="btn btn-info btn-round">
        <i class="material-icons">add</i>
    </a>

    {{-- search post --}}
    <form method="GET" action="{{ route('admin.searchGall') }}" class="pull-right">
      @csrf
    ...
    <div class="col-md-12">
      <div class="card">
        <div class="card-header card-header-rose">
          ...
          <span class="label badge-pill badge-primary pull-right">{{ $galleries->total() }} Poto</span>
