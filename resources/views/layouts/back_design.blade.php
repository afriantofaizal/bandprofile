...
<head>
    ...
    <!-- Material Kit CSS -->
    <link href="{{ asset('assets/back/css/material-dashboard.css?v=2.1.0') }}" rel="stylesheet" />
...
<body class="dark-edition">
    <div class="wrapper ">
        ...
        {{-- sidebar --}}
                                                        @include('layouts.back.back_sidebar')

        <div class="main-panel">
            <!-- Navbar -->
                                                       
                                                        @include('layouts.back.back_header')
            <!-- End Navbar -->
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <div class="copyright float-right">
                        ...
                        <a href="#" target="_blank">Yowis Ben Official</a>
                    </div>
                                                <!-- your footer here -->
                </div>
            </footer>
